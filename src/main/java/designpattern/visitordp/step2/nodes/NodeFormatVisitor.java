...
public class NodeFormatVisitor implements IntValueNodeVisitor<String>,FloatValueNodeVisitor<String>,AddOperationNodeVisitor<String>,
        MultiplyOperationNodeVisitor<String>,DivideOperationNodeVisitor<String>,SubtractOperationNodeVisitor<String>{
